...
public class RatingBar extends LinearLayout {
    ...
    public RatingBar(Context context, AttributeSet attrs) {
        ...
        mWidth = (int) ta.getDimension(R.styleable.RatingBar_starWidth, 0);
        mHeight = (int) ta.getDimension(R.styleable.RatingBar_starHeight, 0);
        mDrawable = ta.getDrawable(R.styleable.RatingBar_starDrawable);
        mColor = ta.getColor(R.styleable.RatingBar_progressColor, context.getResources()
                .getColor(R.color.star_color));
        mRating = ta.getFloat(R.styleable.RatingBar_rating, 0);
        mSpace = (int) ta.getDimension(R.styleable.RatingBar_space, 0);
        mIsIndicator = ta.getBoolean(R.styleable.RatingBar_isIndicator, false);
        init();
    }
