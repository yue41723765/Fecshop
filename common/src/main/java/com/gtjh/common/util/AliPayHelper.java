...
import com.gtjh.common.event.PayResult;
import com.gtjh.common.util.ali.SignUtils;
...
public class AliPayHelper  {
    ...
    private  AliPayClickListener aliPayClickListener;
    // 商户私钥，pkcs8格式
    public static final String RSA_PRIVATE = "MsbylYkCzlfYLy9PeRwUUI";
    public static final String PARTNER = "2015052600090779";
    // 商户收款账号
    public static final String SELLER = "13021393307";
    public AliPayHelper(){}


    public  AliPayHelper getInstance(){
            ...
            if (TextUtils.equals(resultStatus, "9000")) {
               if (aliPayClickListener!=null){
                ...
                if (TextUtils.equals(resultStatus, "8000")) {
                    if (aliPayClickListener!=null){
                        aliPayClickListener.confirm();
                    }
                } else {
                    // 其他值就可以判断为支付失败，包括用户主动取消支付，或者系统返回的错误
                    if (aliPayClickListener!=null){
                        aliPayClickListener.fail();
                    }
                }
            }
    ...
    public  void startAliPaySerVice(final Activity context, final String orderId,String name,String desc,String price ){
    ...
    public  void setAliPayClickListener(AliPayClickListener aliPayClickListener) {
