...
import com.gtjh.router_core.callback.NavigationCallback;
import com.gtjh.router_core.exception.NoRouteFoundException;
...
import com.gtjh.router_core.utils.ClassUtils;
...
public class GTJHRouter {
    private static final String TAG = "GTJHRouter";
    private static final String ROUTE_ROOT_PAKCAGE = "com.gtjh.router.routes";
    private static final String SDK_NAME = "GTJHRouter";
    private static final String SEPARATOR = "_";
    private static final String SUFFIX_ROOT = "Root";
    private static final String SUFFIX_ACTIVITY = "Activity";
    private static Application mContext;

    private static GTJHRouter instance;


    public static GTJHRouter getInstance() {
        synchronized (GTJHRouter.class) {
            if (instance == null) {
                instance = new GTJHRouter();
            }
        }
        return instance;
    }
    ...
    private static void loadInfo() throws InterruptedException, IOException, PackageManager
        ...
        for (String className : routerMap) {
            ...
            }else if(className.startsWith(ROUTE_ROOT_PAKCAGE + "." + SDK_NAME + SEPARATOR +
                    SUFFIX_ACTIVITY)){
                ((IActivity) (Class.forName(className).getConstructor().newInstance())).loadInto
                        (Warehouse.activityClass);
            }
        }
...
//                    .getValue() + "]");
//            Log.e(TAG, "Root映射表"+ Warehouse.groupsIndex.get(card.getGroup()));
//        }
